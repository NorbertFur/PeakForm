  ...
  return (
    <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
        ...
        <div className='flex flex-col'>
            <h3 className='text-slate-400 tx-sm'>Muscles Groups</h3>
        ...
        <button onClick={handleSetIncrement} className='flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-blue-900 hover:boder-blue-600 w-full cursor-pointer'>
